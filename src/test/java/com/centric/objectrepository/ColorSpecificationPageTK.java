...
public class ColorSpecificationPageTK extends Commonactions {

    public ColorSpecificationPageTK() {
        PageFactory.initElements(Commonactions.driver, this);
    }

    @FindBy(xpath = "//span[text()='Color Specifications']")
